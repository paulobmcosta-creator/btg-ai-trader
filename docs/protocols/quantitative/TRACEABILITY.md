...
### Regra Transversal de Aplicabilidade
- A aplicabilidade não transforma um **Hard Quantitative Invariant (HQI)** em parâmetro discricionário (*policy*).
- Se o invariante não for aplicável ao domínio, instrumento ou claim concreto avaliado, ele não se aplica àquele caso específico.
- Se for aplicável, permanece estritamente **HARD** e não compensatório.
- Nenhum *ApplicabilityPredicate* específico por HQI é congelado por esta matriz além dos qualificadores e condições materiais já presentes no próprio texto canônico de cada HQI.

### 3.1. Bloco 0E-A — Semântica Experimental e Hipótese Quantitativa (16 HQIs)

| ID | Invariante | QPI Primário | QPI Secundário |
|---|---|---|---|
...
### 3.2. Bloco 0E-B — Integridade de Dados e Temporalidade (29 HQIs)
...
### 3.3. Bloco 0E-C — Desenho de Validação, OOS e Baselines (32 HQIs)
