...
| **S5-AC-08** | Train-only feature pipeline fitting | REQUIRED | Protocol 0E-C, C-HQI-09, S5-D-02 | `btg_ai_trader.ml_engine.features` | `tests/test_ml_engine_leakage.py` | PASS |
...
| **S5-AC-12** | Stochastic RNG identity | REQUIRED | ADR-0017, DD-13, DD-14 | `btg_ai_trader.ml_engine.domain` | `tests/test_ml_engine_determinism.py` | PASS |
...
| **S5-AC-28** | Protected evidence consumption enforcement | REQUIRED | Protocol 0E-C, S5-D-13 | `btg_ai_trader.ml_engine.evaluation` | `tests/test_ml_engine_leakage.py` | PASS |
...
| **S5-AC-40** | Deterministic repeated-run evidence | REQUIRED | ADR-0017, DD-16 | `btg_ai_trader.ml_engine.evaluation` | `tests/test_ml_engine_determinism.py` | PASS |
...
| **S5-NC-25** | No adaptive protected-test search | Domain evaluation role check | `tests/test_ml_engine_leakage.py` | VERIFIED |
| **S5-NC-26** | No best-seed selection | Selection policy check | `tests/test_ml_engine_selection.py` | VERIFIED |
| **S5-NC-27** | No protected-test feature fitting | Causal leakage check | `tests/test_ml_engine_leakage.py` | VERIFIED |
| **S5-NC-28** | No protected-test hyperparameter selection | Causal leakage check | `tests/test_ml_engine_selection.py` | VERIFIED |
| **S5-NC-29** | No future-label predictor surface | PredictionInput interface enforcement | `tests/test_ml_engine_leakage.py` | VERIFIED |
