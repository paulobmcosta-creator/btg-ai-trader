...
| S3-AC-06 | Explicit configurable fee/cost model | REQUIRED | Protocol 0E-D, DD-74, DD-93, S3-D-08, S3-AC-06 | `btg_ai_trader.backtesting.assumptions` | `tests/backtesting/test_assumptions.py` | PASS |
...
| S3-AC-10 | Simulated economic position accounting | REQUIRED | ADR-0014, ADR-0022, DD-46, S3-D-11 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
| S3-AC-11 | Gross / net P&L with explicit economic units | REQUIRED | ADR-0022, DD-46, DD-47, S3-D-11, S3-AC-11 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
| S3-AC-12 | Cost attribution without double counting | REQUIRED | Protocol 0E-D, DD-46, S3-D-13, S3-D-14, S3-AC-12 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
...
| S3-AC-16 | Assumption sensitivity / cost stress | REQUIRED | Protocol 0E-D, S3-D-17, S3-AC-16 | `btg_ai_trader.backtesting.sensitivity` | `tests/backtesting/test_sensitivity.py` | PASS |
