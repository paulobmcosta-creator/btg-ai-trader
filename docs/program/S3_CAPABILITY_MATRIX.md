...
| S3-AC-06 | Explicit configurable fee/cost model | REQUIRED | Protocol 0E-D, DD-74 (Local Simulation), DD-93 (Parametric FeeSchedule; B3 Production Tariff Deferred), S3-D-08, S3-AC-06 | `btg_ai_trader.backtesting.assumptions` | `tests/backtesting/test_assumptions.py` | PASS |
...
| S3-AC-10 | Simulated economic position accounting | REQUIRED | ADR-0014, ADR-0022, DD-46 (Local Weighted Average Cost Basis; Production Ledger Deferred), S3-D-11 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
| S3-AC-11 | Gross / net P&L with explicit economic units | REQUIRED | ADR-0022, DD-46, DD-47 (Local MTM Valuation; Production Valuation Deferred), S3-D-11, S3-AC-11 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
| S3-AC-12 | Cost attribution without double counting | REQUIRED | Protocol 0E-D, DD-46 (Local Cost Attribution), S3-D-13, S3-D-14, S3-AC-12 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
...
| S3-AC-18 | Explicit end-of-window position policy | REQUIRED | Protocol 0E-D, DD-98, S3-D-15, S3-AC-18 | `btg_ai_trader.backtesting.accounting` | `tests/backtesting/test_accounting.py` | PASS |
...
| S3-AC-25 | Candle intrabar trajectory execution | DEFERRED | Protocol 0E-D, DD-92 | `btg_ai_trader.backtesting.execution` | `tests/backtesting/test_execution.py` | DEFERRED |
